...
public class test {
    public static void main(String[] args) {
        ...
        System.out.println("Test faculty as an employee get name and get salary tests.");
                System.out.println("Employee Name: " + shahram.getName()); // print thefaculty name
        System.out.println("Employee Salary: " + shahram.getSalary()); // print thesalary of faculty
        ...
        if (shahram instanceof Faculty)// why is this needed?
        {
            ...
            String springCourses[] = {"111", "301", "428", "458"}; // create coursesarray
